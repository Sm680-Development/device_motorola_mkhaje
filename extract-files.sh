...
extract "${MY_DIR}/proprietary-files-devon.txt" "${SRC}" "${KANG}" --section "${SECTION}"
extract "${MY_DIR}/proprietary-files-hawao.txt" "${SRC}" "${KANG}" --section "${SECTION}"
extract "${MY_DIR}/proprietary-files-rhode.txt" "${SRC}" "${KANG}" --section "${SECTION}"

...
# Audio - Configs
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/audio/audio_platform_info_devon.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_platform_info_devon.xml \
    $(LOCAL_PATH)/audio/audio_platform_info_hawao.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_platform_info_hawao.xml \
    $(LOCAL_PATH)/audio/audio_platform_info_rhode.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_platform_info_rhode.xml \
    $(LOCAL_PATH)/audio/audio_policy_volumes_devon.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_volumes_devon.xml \
    $(LOCAL_PATH)/audio/audio_policy_volumes_hawao.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_volumes_hawao.xml \
    $(LOCAL_PATH)/audio/audio_policy_volumes_rhode.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_volumes_rhode.xml \
    $(LOCAL_PATH)/audio/default_volume_tables_devon.xml:$(TARGET_COPY_OUT_VENDOR)/etc/default_volume_tables_devon.xml \
    $(LOCAL_PATH)/audio/default_volume_tables_hawao.xml:$(TARGET_COPY_OUT_VENDOR)/etc/default_volume_tables_hawao.xml \
    $(LOCAL_PATH)/audio/default_volume_tables_rhode.xml:$(TARGET_COPY_OUT_VENDOR)/etc/default_volume_tables_rhode.xml \
    $(LOCAL_PATH)/audio/mixer_paths_devon.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_devon.xml \
    $(LOCAL_PATH)/audio/mixer_paths_hawao.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_hawao.xml \
    $(LOCAL_PATH)/audio/mixer_paths_rhode.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_devon.xml
...
PRODUCT_PACKAGES *= \
    ...
    hawaoFrameworkOverlay
    rhodeFrameworkOverlay
    devonSettingsOverlay
    hawaoSettingsOverlay
    rhodeSettingsOverlay
    devonSystemUIOverlay
    hawaoSusyemUIOverlay
    rhodeSystemUIOverlay
...
PRODUCT_PACKAGES += \
    ...
    init.target.rc \
    ueventd.qcom.rc \
    init.devon.fingerprint2.sh \
    init.hawao.fingerprint2.sh \
    init.rhode.fingerprint2.sh \
    init.mkhaje.sh \
    init_common.rc \
    init_devon.rc \
    init_hawao.rc \
...
$(call inherit-product-if-exists, vendor/motorola/mkhaje/mkhaje-vendor.mk)
